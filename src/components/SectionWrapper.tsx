...
const decorationMap: Record<string, { src: string; className: string }> = {
  ...
  'cross-medical': {
    ...
    className:
      'absolute top-12 left-10 w-24 opacity-85 pointer-events-none select-none',
  },
  pill: {
    src: '/pill.svg',
    className:
      'absolute bottom-10 left-12 w-20 opacity-30 pointer-events-none select-none',
  },
  stethoscope: {
    src: '/stethoscope.svg',
    className:
      'absolute bottom-6 right-10 w-28 opacity-20 pointer-events-none select-none',
  },
};
